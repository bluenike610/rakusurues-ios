...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = Config.BUBBLE
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = Config.BUBBLE
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = Config.BUBBLE
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    open var optionCalendarUnderlinedBackgroundColor = Config.BUBBLE
    ...
    open var optionClockBackgroundColorAMPMHighlight = Config.BUBBLE
    ...
    open var optionClockBackgroundColorHourHighlight = Config.BUBBLE
    open var optionClockBackgroundColorHourHighlightNeedle = Config.BUBBLE
    ...
    open var optionClockBackgroundColorMinuteHighlight = Config.BUBBLE
    open var optionClockBackgroundColorMinuteHighlightNeedle = Config.BUBBLE
    ...
    open var optionButtonFontColorCancel = Config.BUBBLE
    open var optionButtonFontColorDone = Config.BUBBLE
    open var optionButtonFontColorCancelHighlight = Config.BUBBLE.withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = Config.BUBBLE.withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor = Config.BUBBLE
    ...
    open var optionSelectorPanelBackgroundColor = Config.BUBBLE.withAlphaComponent(0.9)
    ...
    fileprivate var tintColor : UIColor! = Config.BUBBLE
